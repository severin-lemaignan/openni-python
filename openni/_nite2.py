...
class NiteJointType(CEnum):
    _names_ = {'NITE_JOINT_RIGHT_ELBOW': 5, 'NITE_JOINT_LEFT_ELBOW': 4, 'NITE_JOINT_RIGHT_KNEE': 12, 'NITE_JOINT_RIGHT_HAND': 7, 'NITE_JOINT_RIGHT_SHOULDER': 3, 'NITE_JOINT_HEAD': 0, 'NITE_JOINT_LEFT_HAND': 6,
               'NITE_JOINT_LEFT_SHOULDER': 2, 'NITE_JOINT_LEFT_KNEE': 11, 'NITE_JOINT_TORSO': 8, 'NITE_JOINT_NECK': 1, 'NITE_JOINT_LEFT_HIP': 9, 'NITE_JOINT_RIGHT_HIP': 10, 'NITE_JOINT_LEFT_FOOT': 13, 'NITE_JOINT_RIGHT_FOOT': 14}
    _values_ = {0: 'NITE_JOINT_HEAD', 1: 'NITE_JOINT_NECK', 2: 'NITE_JOINT_LEFT_SHOULDER', 3: 'NITE_JOINT_RIGHT_SHOULDER', 4: 'NITE_JOINT_LEFT_ELBOW', 5: 'NITE_JOINT_RIGHT_ELBOW', 6: 'NITE_JOINT_LEFT_HAND',
                7: 'NITE_JOINT_RIGHT_HAND', 8: 'NITE_JOINT_TORSO', 9: 'NITE_JOINT_LEFT_HIP', 10: 'NITE_JOINT_RIGHT_HIP', 11: 'NITE_JOINT_LEFT_KNEE', 12: 'NITE_JOINT_RIGHT_KNEE', 13: 'NITE_JOINT_LEFT_FOOT', 14: 'NITE_JOINT_RIGHT_FOOT'}
    NITE_JOINT_HEAD = 0
    NITE_JOINT_NECK = 1
...
class NiteSkeletonState(CEnum):
    _names_ = {'NITE_SKELETON_CALIBRATION_ERROR_HEAD': 5, 'NITE_SKELETON_CALIBRATION_ERROR_NOT_IN_POSE': 3, 'NITE_SKELETON_TRACKED': 2, 'NITE_SKELETON_CALIBRATION_ERROR_LEGS': 6,
               'NITE_SKELETON_CALIBRATION_ERROR_HANDS': 4, 'NITE_SKELETON_CALIBRATING': 1, 'NITE_SKELETON_CALIBRATION_ERROR_TORSO': 7, 'NITE_SKELETON_NONE': 0}
    _values_ = {0: 'NITE_SKELETON_NONE', 1: 'NITE_SKELETON_CALIBRATING', 2: 'NITE_SKELETON_TRACKED', 3: 'NITE_SKELETON_CALIBRATION_ERROR_NOT_IN_POSE',
                4: 'NITE_SKELETON_CALIBRATION_ERROR_HANDS', 5: 'NITE_SKELETON_CALIBRATION_ERROR_HEAD', 6: 'NITE_SKELETON_CALIBRATION_ERROR_LEGS', 7: 'NITE_SKELETON_CALIBRATION_ERROR_TORSO'}
